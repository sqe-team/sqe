...
final class CheckstylePanel extends javax.swing.JPanel {

    private final CheckstyleConfiguration checkstyleConfiguration;
    private final CheckstyleOptionsPanelController controller;

    CheckstylePanel(CheckstyleOptionsPanelController controller) {
        this.controller = controller;
        initComponents();
        checkstyleConfiguration = new CheckstyleConfiguration();
        this.add(checkstyleConfiguration, BorderLayout.CENTER);
    ...
    void load() {
        FileObject checkstyleConfigurationFile = GlobalCheckstyleSettings.INSTANCE.getCheckstyleConfigurationFile();
        ...
        checkstyleConfiguration.setProperties(GlobalCheckstyleSettings.INSTANCE.getPropertiesAsString());
    }

    void store() {
        GlobalCheckstyleSettings.INSTANCE.setCheckstyleConfigurationPath(checkstyleConfiguration.getConfigFilePath());
        GlobalCheckstyleSettings.INSTANCE.setPropertiesPath(checkstyleConfiguration.getPropertiesFilePath());
