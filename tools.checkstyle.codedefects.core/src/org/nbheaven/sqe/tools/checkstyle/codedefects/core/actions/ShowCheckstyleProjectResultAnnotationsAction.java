 ...
 */
public final class ShowCheckstyleProjectResultAnnotationsAction extends AbstractShowProjectResultAnnotationsAction implements ContextAwareAction {

    public ShowCheckstyleProjectResultAnnotationsAction() {
        this(Utilities.actionsGlobalContext());
    }

    public ShowCheckstyleProjectResultAnnotationsAction(CheckstyleSession session) {
        this(SQEProjectSupport.createContextLookup(session.getProject()));
    }

    private ShowCheckstyleProjectResultAnnotationsAction(Lookup context) {
    ...
    @Override
    public ShowCheckstyleProjectResultAnnotationsAction createContextAwareInstance(Lookup context) {
        return new ShowCheckstyleProjectResultAnnotationsAction(context);
    }
