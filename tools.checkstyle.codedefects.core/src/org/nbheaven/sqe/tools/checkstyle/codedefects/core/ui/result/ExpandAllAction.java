...
class ExpandAllAction extends AbstractAction {
    ...
    private final static Icon expandIcon = new ImageIcon(ImageUtilities.loadImage("org/nbheaven/sqe/tools/checkstyle/codedefects/core/resources/expandTree.png"));
