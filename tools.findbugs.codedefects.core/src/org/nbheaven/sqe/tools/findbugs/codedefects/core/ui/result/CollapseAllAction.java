...
class CollapseAllAction extends AbstractAction {
    ...
    private final static Icon collapseIcon = new ImageIcon(ImageUtilities.loadImage("org/nbheaven/sqe/tools/findbugs/codedefects/core/resources/collapseTree.png"));
