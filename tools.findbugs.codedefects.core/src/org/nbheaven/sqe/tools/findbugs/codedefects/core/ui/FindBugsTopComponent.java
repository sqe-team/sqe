...
@ConvertAsProperties(
        dtd = "-//org.nbheaven.sqe.tools.findbugs.codedefects.core.ui//FindBugsTopComponent//EN",
        autostore = false
)
...
@TopComponent.OpenActionRegistration(
        displayName = "#CTL_FindBugsAction",
        preferredID = FindBugsTopComponent.PREFERRED_ID)
@Messages({
    "CTL_FindBugsAction=FindBugs",
    "CTL_FindBugsTopComponent=FindBugs",
    "HINT_FindBugsTopComponent=This is the SQE FindBugs window."
})
public final class FindBugsTopComponent extends TopComponent {
    ...
    private FindBugsTopComponent() {
        ...
        setName(Bundle.CTL_FindBugsTopComponent());
        setToolTipText(Bundle.HINT_FindBugsTopComponent());
    }
    ...
    private void setActiveSessionByProject(final Project project) {
        ...
        if (null != project) {
            setActiveSession(SQECodedefectSupport.retrieveSession(project, FindBugsSession.class));
    ...
    private void setActiveSession(final FindBugsSession session) {
