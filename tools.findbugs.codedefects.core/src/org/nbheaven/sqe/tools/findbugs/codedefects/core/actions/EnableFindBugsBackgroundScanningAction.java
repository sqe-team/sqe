 ...
 */
public final class EnableFindBugsBackgroundScanningAction extends AbstractEnableBackgroundScanningAction implements ContextAwareAction {

    public EnableFindBugsBackgroundScanningAction() {
        this(Utilities.actionsGlobalContext());
    }

    public EnableFindBugsBackgroundScanningAction(FindBugsSession session) {
    ...
    @Override
    public EnableFindBugsBackgroundScanningAction createContextAwareInstance(Lookup context) {
        return new EnableFindBugsBackgroundScanningAction(context);
    }
