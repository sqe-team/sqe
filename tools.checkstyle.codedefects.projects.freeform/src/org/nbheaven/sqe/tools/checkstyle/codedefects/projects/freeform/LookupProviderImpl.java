...
public class LookupProviderImpl implements LookupProvider {
    ...
    public Lookup createAdditionalLookup(Lookup context) {
        ...
        CheckstyleSession checkstyleSession = CheckstyleQualityProvider.getDefault().createQualitySession(p);
        CheckstyleSettingsProviderImpl providerImpl = new CheckstyleSettingsProviderImpl(p);
        return Lookups.fixed(checkstyleSession, providerImpl);
    }
